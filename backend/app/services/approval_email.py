...
def _approval_html(*, record: dict, base_url: str) -> str:
  ...
  <div style="max-width:640px;margin:auto;background:#fff;border-radius:12px;padding:28px;border:1px solid #e5e7eb">
    ...
    <div style="margin:22px 0 8px;padding:14px;background:#eff6ff;border:1px solid #bfdbfe;border-radius:8px">
      <p style="margin:0 0 10px;color:#1e40af;font-weight:700">Need to fix a clip?</p>
      <p style="margin:0 0 12px;color:#1e3a8a;font-size:13px">
        If any scene didn't generate well, open the review page to tick the bad clip(s)
        and regenerate just those — everything else stays exactly as it is, and you'll
        get a fresh email with the replaced clips.
      </p>
      <a href="{base_url}/api/approvals/review?token=__TOKEN__"
         style="display:inline-block;background:#2563eb;color:#fff;text-decoration:none;
                padding:11px 24px;border-radius:8px;font-weight:700">🔁 Review &amp; regenerate clips</a>
    </div>
    ...
    <p style="color:#999;font-size:12px;margin-top:18px">
      First response decides. If the other owner has already responded, your click
      will simply show the current status — nothing is regenerated. Approve only once
      the clips look right (or after a regeneration email arrives).
    </p>
  </div></body></html>"""
