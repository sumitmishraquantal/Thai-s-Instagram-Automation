...
#          "background_environment": "Warm podcast studio, soft amber lights, acoustic panels"},
...
#          "background_environment": "Same studio, bookshelf and plant behind guest"},
...
#          "background_environment": "Same studio, soft rim lighting on the guest"},
#     ],
# }
...
# Two people sit ACROSS a desk from each other in the same studio: HOST and GUEST.
# This is an in-person conversation — they mostly look AT EACH OTHER, not at the camera.
# Title: {title}
...
# video generator, DERIVED FROM THE ACTUAL LINE being spoken. Keep the setting one
# consistent podcast studio across scenes (character/scene consistency is critical).
...
# - eye_contact: where the speaker looks — usually AT THE OTHER PERSON across the desk, sometimes down at the desk or mic in thought, only an occasional brief glance toward camera. Never a fixed camera stare.
...
# "reaction_cue": "...", "camera_movement": "...", "background_environment": "..."}}]}}
...
# MOCK_CANON = {
#     "studio": "An intimate modern podcast studio with warm amber accent lighting, dark acoustic foam panels, a walnut wood desk with two black dynamic microphones on boom arms, a soft-glow neon ring on the back wall, and a leafy plant in the corner.",
#     "host": "RON, a 38-year-old Indian man with short black hair, trimmed beard, wearing a navy crew-neck sweater and silver over-ear headphones, curious and professional demeanor",
#     "guest": "JASON, a 45-year-old man with salt-and-pepper short hair and beard, wearing a charcoal blazer over a plain white t-shirt and black over-ear headphones, calm and warm demeanor",
# }
